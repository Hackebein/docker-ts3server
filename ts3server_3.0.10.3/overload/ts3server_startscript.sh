...
export TS3SERVER_DB_SQLPATH=${TS3SERVER_DB_SQLPATH:-sql}
...
TS3SERVER_DB_SQLCREATEPATH=$(trailingslash "${TS3SERVER_DB_SQLCREATEPATH}")
TS3SERVER_DB_SQLPATH=$(trailingslash "${TS3SERVER_DB_SQLPATH}")
